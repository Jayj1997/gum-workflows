...
func TestSeedsDefinitions(t *testing.T) {
	...
	want := []string{"architecture-design", "coding-agent", "go-complexity-check", "go-coverage-check", "go-race-check", "go-static-analysis", "human-approval", "human-input", "openapi-generator", "requirement-analysis"}
...
func TestSeedsTypeClassification(t *testing.T) {
	...
	wantType := map[string]definition.NodeType{
		...
		"go-complexity-check":  definition.TypeAutomation,
